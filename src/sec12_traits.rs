...
fn print_type<T: fmt::Debug>(item: T) {
    println!("[sec12:print_type] Type of {:?} is {}", item, any::type_name::<T>());
}
...
{
    if a == T::from(b) {
        println!("[sec12:compare_and_print] {} is equal to {}", a, b);
    }
    else {
        println!("[sec12:compare_and_print] {} is NOT equal to {}", a, b);   
    }
}
...
pub fn study_fn() {
    ...
    println!("[sec12::study_fn] Hubble - {}", hubble.describe());
    println!("[sec12::study_fn] ISS - {}", iss.describe());
    ...
    println!("[sec12::study_fn] Hubble == GPS is {}", hubble == gps);
    println!("[sec12::study_fn] Hubble > GPS is {}", hubble > gps);
    ...
    println!("[sec12::study_fn] Get Display - {}", get_displayable());
}
